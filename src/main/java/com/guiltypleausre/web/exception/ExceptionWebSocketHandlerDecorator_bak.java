 ...
 * @since 4.0
 */
public class ExceptionWebSocketHandlerDecorator_bak extends WebSocketHandlerDecorator {

	private static final Log logger = LogFactory.getLog(ExceptionWebSocketHandlerDecorator_bak.class);


	public ExceptionWebSocketHandlerDecorator_bak(WebSocketHandler delegate) {
		super(delegate);
	}
